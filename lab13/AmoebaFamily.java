...
public class AmoebaFamily implements Iterable<AmoebaFamily.Amoeba> {
    ...
    public static void main(String[] args) {
        ...
        //meiting adds some tests below:
        String testLongestName = family.longestName();
        int testLongestNameLen = family.longestNameLength();
        System.out.println(testLongestName);
        System.out.println(testLongestNameLen);
    }
    ...
    public static class Amoeba {
        ...
        public String longestNameHelper() {
            ...
            for (Amoeba a: children) {
                String subTreeName = a.longestNameHelper();
                if (subTreeName.length() > longestName.length()) {
                    longestName = subTreeName;
                }
            }
            return longestName;
        }
